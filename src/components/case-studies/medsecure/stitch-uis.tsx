                                ...
                                <div className="text-white font-sans" style={{ fontFamily: "'Lexend', sans-serif" }}>
                                    ...
                                    <div className="bg-[#0a0f1e] px-5 py-3 flex items-center justify-between border-b border-white/5">
                                        ...
                                        <div className="flex gap-2">
                                            <span className="px-2.5 py-1 rounded-lg bg-red-600 text-white text-xs font-black">Blood: B+</span>
                                            <span className="px-2.5 py-1 rounded-lg bg-red-600/30 border border-red-500 text-red-400 text-xs font-black">⚠ Penicillin ALLERGY</span>
                                        </div>
                                    ...
                                    <div className="bg-[#0a0f1e] px-5 py-3 flex items-center justify-between border-t border-white/5 gap-3 flex-wrap">
                                        <button className="flex-1 py-2 px-4 rounded-xl bg-red-600 text-white text-xs font-black hover:bg-red-500 transition-colors">
