...
const experiences = [
    ...
    },
    {
        ...
        period: "2020 - 2022",
        metric: "73% Team Adoption Increase",
        metricDesc: "Redesigned 12 CRM dashboards, cut data access time 29%, led team of 5.",
        description: "Spearheaded overhaul of 12 CRM and internal dashboards — restructured IA to cut data access time by 29%. Introduced motion graphics that boosted user interaction by 30%. Led a team of 5 designers.",
        icon: Layout,
