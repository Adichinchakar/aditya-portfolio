...
const experiences = [
    ...
    },
    {
        ...
        period: "2024 - Present",
        metric: "Materially Faster Assessment Cycles",
        metricDesc: "Led design architecture for GenAI-powered educational tools for a US K-12 EdTech client.",
    ...
    },
    {
        ...
        role: "UI/UX Designer",
        period: "2022 - 2024",
        metric: "Step-Change in User Adoption",
        metricDesc: "Led UX for Flow Builder — the core enterprise AI automation engine.",
        description: "Only designer on the team. Redesigned the node-based workflow builder from scratch, ran 25+ JTBD interviews across enterprise clients, and built the company's first design system — substantially cutting dev handoff time.",
        icon: Zap,
    ...
    },
    {
        ...
        period: "2020 - 2022",
        metric: "Strong Team Adoption Gains",
        metricDesc: "Redesigned 12 CRM dashboards, cut data access time, led team of 5.",
        description: "Spearheaded overhaul of 12 CRM and internal dashboards — restructured IA to meaningfully cut data access time. Introduced motion graphics that lifted user interaction. Led a team of 5 designers.",
        icon: Layout,
