...
const experiences = [
    {
        ...
        period: "2022 - Present",
        metric: "0→1 AI Accessibility Tool",
        metricDesc: "Built solo from concept to production — design, engineering, and product.",
        description: "Designed and shipped an AI-powered Figma plugin for WCAG 2.2 compliance automation. 500+ frames scanned per run, under 10 seconds per document. 30+ beta designers in active testing.",
        icon: Sparkles,
    ...
    },
    {
        ...
        period: "2023 - Present",
        metric: "70% Faster Assessment Cycles",
        metricDesc: "Led design architecture for GenAI-powered educational tools at Imagine Learning.",
        description: "Architected AI-driven rubric generators and adaptive recommendation engines. Built a unified design system across 5 product teams — zero component forks. Designed 3 AI tools shipped to production.",
        icon: Bot,
        color: "text-blue-600",
        bg: "bg-blue-50",
    ...
    },
    {
        ...
        metricDesc: "Led UX for Flow Builder — the core enterprise automation engine.",
        description: "Only senior designer on the team. Redesigned the node-based workflow builder from scratch, ran 100+ user interviews across 8 enterprise clients, and built the company's first design system — cutting dev cycles by 42%.",
        icon: Zap,
    ...
    },
    {
        ...
        role: "UI/UX Designer",
        period: "2019 - 2021",
        metric: "8 Dashboard Modules Shipped",
        metricDesc: "Redesigned core CRM and reporting suite for an AdTech SaaS platform.",
        description: "Delivered 8 dashboard modules across CRM, campaign analytics, and reporting — reducing task completion time by 28%. Introduced the company's first design tokens and component library.",
        icon: Layout,
